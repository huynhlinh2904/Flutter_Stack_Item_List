...
class SnackPack extends StatefulWidget {
  const SnackPack({Key? key}) : super(key: key);

  @override
  State<SnackPack> createState() => _SnackPackState();
}

class _SnackPackState extends State<SnackPack> {
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        child: const Align(
                          child: Text('Sáng', style: TextStyle(fontSize: 15)),
                ...
                child: SizedBox(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Container(
                        child: const Align(
                          child: Text('Trưa', style: TextStyle(fontSize: 15)),
                          alignment: Alignment.topCenter,
                        ),
                      ),
                      Expanded(
                      ...
                      Column(
                        children: [
                          ...
                          DropdownButton<String>(
                            ...
                            items: const <DropdownMenuItem<String>>[
                              DropdownMenuItem(
                                child: Text('ĐẠI Học UEF'),
                                value: '3',
                              ),
                              DropdownMenuItem(
                                child: Text('ĐẠI Học UFO'),
                                value: '1',
                              ),
                            ],
                            onChanged: (String? newValue) {
